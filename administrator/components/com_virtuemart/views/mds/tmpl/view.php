			...
			<tr>
				<td width="50%">
					<fieldset class="parallel_target" style="background-color: rgb(246, 246, 246);">
						...
						<table>
							<?php
								echo '<tr><td>Waybill <a href="javascript:void(0);" rel="wrapped_waybill" class="show_waybill">'.$this->order->waybill.'</a></td></tr>'.'<tr><td>Status: '.$this->tracking['status_text'].'</td></tr>';
